...
class RolSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'categorias.show','description'=>'ver categoria'])->assignRole([$rol1,$rol2,$rol4]);
        Permission::create(['name'=>'categorias.destroy','description'=>'eliminar categoria'])->assignRole([$rol1,$rol2]);

        Permission::create(['name'=>'ciudades.index','description'=>'ver lista de ciudades'])->assignRole([$rol1,$rol2,$rol3]);
        ...
        Permission::create(['name'=>'ciudades.show','description'=>'ver ciudades'])->assignRole([$rol1,$rol2,$rol3]);
        Permission::create(['name'=>'ciudades.destroy','description'=>'eliminar ciudades'])->assignRole([$rol1,$rol2]);

        Permission::create(['name'=>'edificios.index','description'=>'ver lista de edificios'])->assignRole([$rol1,$rol2,$rol3]);
        ...
        Permission::create(['name'=>'edificios.show','description'=>'ver edificios'])->assignRole([$rol1,$rol2,$rol3]);
        ...
        Permission::create(['name'=>'movimientos.show','description'=>'ver un movimiento'])->assignRole([$rol1,$rol2,$rol3]);
        ...
        Permission::create(['name'=>'departamentos.index','description'=>'ver lista de departamentos'])->assignRole([$rol1,$rol2,$rol3]);
        Permission::create(['name'=>'departamentos.create','description'=>'crear departamentos'])->assignRole([$rol1, $rol2]);
        Permission::create(['name'=>'departamentos.edit','description'=>'editar departamentos'])->assignRole([$rol1, $rol2,$rol3]);
        ...
        Permission::create(['name'=>'estados.show','description'=>'ver estado'])->assignRole([$rol1,$rol2]);
        ...
        Permission::create(['name'=>'proveedores.show','description'=>'ver proveedor'])->assignRole([$rol1,$rol2]);
        ...
        Permission::create(['name'=>'administrar_bitacoras','description'=>'revisar la bitacora'])->assignRole([$rol1]);


        Permission::create(['name'=>'egresos.index','description'=>'ver lista de activos fijos egresados'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'egresos.show','description'=>'ver egreso de un activo fijo'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'egresos.destroy','description'=>'eliminar un egreso deun activo fijo'])->assignRole([$rol1,$rol2]);

        Permission::create(['name'=>'almacenes.index','description'=>'ver lista de almacenes'])->assignRole([$rol1,$rol2,$rol3]);
        Permission::create(['name'=>'almacenes.create','description'=>'crear almacen'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'almacenes.edit','description'=>'eidtar almacen'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'almacenes.show','description'=>'ver almacen'])->assignRole([$rol1,$rol2,$rol3]);
        Permission::create(['name'=>'almacenes.destroy','description'=>'eliminar almacen'])->assignRole([$rol1,$rol2]);

        Permission::create(['name'=>'activos.index','description'=>'ver lista de activos fijos'])->assignRole([$rol1,$rol2,$rol3,$rol4]);
        Permission::create(['name'=>'activos.show','description'=>'ver un activo fijo'])->assignRole([$rol1,$rol2,$rol3,$rol4]);
        Permission::create(['name'=>'activos.create','description'=>'crear un activo fijo'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'activos.edit','description'=>'editar un activo fijo'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'activos.destroy','description'=>'eliminar un activo fijo'])->assignRole([$rol1,$rol2]);

        Permission::create(['name'=>'revaluos.index','description'=>'ver lista de revaluos'])->assignRole([$rol1,$rol4]);
        Permission::create(['name'=>'revaluos.show','description'=>'ver un revaluo'])->assignRole([$rol1,$rol4]);
        Permission::create(['name'=>'revaluos.destroy','description'=>'eliminar un revaluo'])->assignRole([$rol1,$rol4]);
        Permission::create(['name'=>'revaluos.create','description'=>'crear un revaluo'])->assignRole([$rol1,$rol4]);
        Permission::create(['name'=>'revaluos.edit','description'=>'editar un revaluo'])->assignRole([$rol1,$rol4]);

        Permission::create(['name'=>'depreciacion.index','description'=>'ver lista de depreciaciones'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'depreciacion.show','description'=>'ver una depreciacion'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'depreciacion.destroy','description'=>'eliminar una depreciacion'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'depreciacion.create','description'=>'crear una depreciacion'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'depreciacion.edit','description'=>'editar una depreciacion'])->assignRole([$rol1,$rol2]);

        Permission::create(['name'=>'codificacion.index','description'=>'ver lista de codificaciones'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'codificacion.show','description'=>'ver un codigo'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'codificacion.destroy','description'=>'eliminar un codigo'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'codificacion.create','description'=>'crear un codigo'])->assignRole([$rol1,$rol2]);
        Permission::create(['name'=>'codificacion.edit','description'=>'editar un codigo'])->assignRole([$rol1,$rol2]);
