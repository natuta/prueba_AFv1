  ...
  pdf.save('filename.pdf');
   ...
   <body> 
    ...
    <div id="reportPage" style="width: 100%; height:100%">
        ...
        <canvas id="myChart" style="width: 25px; height:25px;clear: both;"></canvas>
    </div>

    <div  style="width: 40%; height:40%; float:right;">
        <canvas id="myChart2"style="width: 25px; height:25px;clear: both;"></canvas>
    </div>

    <br/><br/><br/>

    <div  style="width: 40%; height:40%; float:left;">
        <canvas id="myChart3"style="width: 25px; height:25px;clear: both;"></canvas>
    </div>
    <div  style="width: 40%; height:40%; float:right;">
        <canvas id="myChart4"style="width: 25px; height:25px;clear: both;"></canvas>
    </div>
