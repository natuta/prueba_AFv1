...
$('#downloadPdf').click(function(event) {
  ...
  justify-content: center;" >
   ...
   <div id="reportPage"  style="width: 100%; height: 100%;" >
            ...
            <br/><br/>
        <div id="chartContainer" style="width: 60%; border-color:gray; border-width: 1px; border-style:dotted; padding:10px 20px; float:left;">
            <canvas id="myChart"></canvas>
        </div>

        <div style="width: 70%; border-color: gray; border-width: 1px; border-style:dotted; padding:10px 20px; float: left;">
            <canvas id="myChart2"></canvas>
        </div>

        <br/><br/><br/>

        <div style="width: 70%; clear: both; border-color: gray; border-width: 1px;border-style:dotted; padding:10px 20px; clear: both;">
