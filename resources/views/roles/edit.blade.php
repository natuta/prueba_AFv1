<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-10 lg:px-10 md:grid md:grid-cols-3 md:gap-6 ">
        ...
        <form action="{{route('roles.update',$rol->id)}}" method="POST" class="mt-4 md:mt-0 md:col-span-2">
            @csrf
            @method("PUT")
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <x-jet-input id="name" name="name" value="{{$rol->name}}" type="text" class="mt-1 block w-full" />
                            @error('name')
                        ...
                        <div class="col-span-6 sm:col-span-3 black-text text-bold font-medium">
                            <div class="font-weight-bold">
                                <ul>Lista de permisos</ul>
                            </div>
                            @foreach($permissions as $rbr)
                        ...
                        <div class="col-span-6 sm:col-span-3 black-text text-bold font-medium">
                            <div class="font-weight-bold">
                                <ul>Lista de permisos pertenecientes al rol</ul>
                            </div>
                            @foreach($ownedroles as $own)
                                <label class="flex justify-start items-start black-text mt-2">

                                    <div>
                                        <li><strong>{{$own->description}}</strong></li>
                                    </div>
                                </label>
                            @endforeach
                        </div>
